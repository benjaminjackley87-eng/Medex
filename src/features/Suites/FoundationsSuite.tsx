...
const SciencesExplorer = lazy(() => import('../../pages/SciencesExplorer'));
const GenericPharmacologyView = lazy(() => import('../../pages/GenericPharmacologyView'));
const AnaestheticsCCView = lazy(() => import('../../pages/AnaestheticsCCView'));
const NeuropraxiaView = lazy(() => import('../../pages/NeuropraxiaView'));
