...
import ClinicalFinder from '../../views/ClinicalFinder';
import ClinicalCorrelationView from '../../views/ClinicalCorrelationView';
import DermatologyRevisor from '../DermatologyRevisor';
