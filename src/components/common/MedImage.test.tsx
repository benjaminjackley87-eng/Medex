...
describe('MedImage', () => {
  ...
  it('renders standard src image', () => {
    const { container, getByText } = render(
      <MedImage src="http://example.com/test.jpg" alt="test" label="Test Label" />
    );
  ...
  it('shows edit controls when isEditMode is true and has image', () => {
    const { getByTitle } = render(
      <MedImage src="http://example.com/test.jpg" alt="test" label="Label" isEditMode={true} />
    );
